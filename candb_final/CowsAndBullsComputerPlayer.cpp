...
CowsAndBullsComputerPlayer::number_including_bulls_creating() {
...
CowsAndBullsComputerHelper
CowsAndBullsComputerPlayer::computer_guessing(CowsAndBullsAnswer answer) {
...
CowsAndBullsComputerPlayer::CowsAndBullsComputerPlayer(unsigned char n[4])
