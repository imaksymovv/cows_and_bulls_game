...
public:
    ...
    * 
    * Contructor recieves variable "n" - number that the computer's opponent need to guess
    *******************************************************************************/
...
private:
    ...
    unsigned char amount_of_bulls = 0; ///< stores the number of bulls when bull is detected 
    unsigned char memory_for_number[4]; ///< saves the previous state of the computer number before changing it
    ...
    bool cow_number_substitute = false; /**< becomes true to show that number need to be created without cows_checker
                                        in it*/
